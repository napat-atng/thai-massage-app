...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (error === 'missing_code') {
      setErrorMessage('ไม่พบรหัสยืนยันจาก Google กรุณาลองใหม่อีกครั้ง')
      return
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-stone-100">
      <div className="card w-full max-w-sm text-center">
        ...
        <p className="text-stone-500 text-sm mb-8">จองนัดนวดออนไลน์ได้ง่าย ๆ</p>
        ...
        >
          ...
          {isLoading ? 'กำลังไปที่ Google...' : 'เข้าสู่ระบบด้วย Google'}
        </button>
